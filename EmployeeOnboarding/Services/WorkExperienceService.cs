...
namespace EmployeeOnboarding.Services
{
    ...
    public class WorkExperienceService
    {
        ...
        public void AddExperiences(int empId, List<WorkExperienceVM> experiences)
        {
            foreach (var experience in experiences)
            {
                ...
                if (existingExperience != null)
                {
                    ...
                    existingExperience.Exp_Certificate = SaveCertificateFile(
                        experience.Exp_Certificate, empId.ToString(), "Experience.pdf");
                ...
                else
                {
                    ...
                    var newExperience = new EmployeeExperienceDetails()
                    {
                        EmpGen_Id = empId,
                        ...
                        // Save the certificate file
                        Exp_Certificate = SaveCertificateFile(
                            experience.Exp_Certificate, empId.ToString(), certificateFileName),
        ...
        public IEnumerable<getExperienceVM> GetAllExperiences()
        {
            var experiences = _context.EmployeeExperienceDetails.Select(experience => new getExperienceVM()
            {
                Company_name = experience.Company_name,
                Designation = experience.Designation,
                Reason = experience.Reason,
